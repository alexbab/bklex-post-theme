jQuery(function($) {
    ...
    var clicked = function() {
        ...
        $.getJSON("wp-content/themes/bklex-post-theme/js/e-mail.json", function(response) {
    ...
    $(window).scroll(function() {
        ...
        if (windowYOffset < 1.5 * $(window).height()) {
            var elBackgrounPos = windowYOffset * .5 + "px";
...
window.studioCarousel = function() {
    jQuery(function($) {
        ...
        $.getJSON(templateUrl + "/js/studio-photos.json", function(response) {
            photos = response;
